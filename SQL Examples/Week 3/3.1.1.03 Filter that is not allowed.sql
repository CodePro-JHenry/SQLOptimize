...
CREATE NONCLUSTERED INDEX IXF_Product_SizeUnitMeasureCode_CM2 ON Production.Product (ProductID, ProductNumber)
WHERE SizeUnitMeasureCode IN (SELECT 'CM', 'DC', 'BA');
